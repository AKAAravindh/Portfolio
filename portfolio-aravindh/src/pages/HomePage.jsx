...
export default function HomePage() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Paragraphs Fade-in (skips hero social links because they don’t have .intro-text)
          ...
          <div className="flex gap-8 bottom-20 mt-10">
            <div>
              <SiGithub
                ...
                onClick={() =>
                  window.open("https://github.com/AravindhRaj", "_blank")
                }
              />
              <p>GitHub</p>
            </div>
            <div>
              <SiLinkedin
                ...
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/raj-aravindh/",
                    "_blank"
                  )
                }
              />
            ...
            <div>
              <SiLeetcode
                className="w-6 h-6 text-gray-200 hover:text-[#00ADB5] transition-colors duration-300 heroSocialLinks"
                onClick={() =>
                  window.open("https://leetcode.com/AravindhRaj/", "_blank")
                }
              />
              <p>LeetCode</p>
            </div>
            <div>
              <SiInstagram
                ...
                onClick={() =>
                  window.open(
                    "https://www.instagram.com/raj_aravindh/",
                    "_blank"
                  )
                }
              />
